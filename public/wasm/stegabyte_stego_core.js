/* @ts-self-types="./stegabyte_stego_core.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function stegabyte_decode(pixels, width, height) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.stegabyte_decode(retptr, ptr0, len0, width, height);
 ...
 * @returns {Uint8Array}
 */
export function stegabyte_encode(pixels, payload, width, height, original_length) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        ...
        wasm.stegabyte_encode(retptr, ptr0, len0, ptr1, len1, width, height, original_length);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {number}
 */
export function stegabyte_entropy(pixels) {
    const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.stegabyte_entropy(ptr0, len0);
    return ret;
}
 ...
 * @returns {number}
 */
export function stegabyte_header_bytes() {
    const ret = wasm.stegabyte_header_bytes();
    return ret >>> 0;
}
 ...
 * @returns {Uint32Array}
 */
export function stegabyte_histogram(pixels) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.stegabyte_histogram(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
 ...
 * @returns {number}
 */
export function stegabyte_lsb_capacity(width, height) {
    const ret = wasm.stegabyte_lsb_capacity(width, height);
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function stegabyte_lsb_suspicion(pixels) {
    const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.stegabyte_lsb_suspicion(ptr0, len0);
    return ret;
}
 ...
 * @returns {number}
 */
export function stegabyte_max_dimension() {
    const ret = wasm.stegabyte_max_dimension();
    return ret >>> 0;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./stegabyte_stego_core_bg.js": import0,
    };
}
...
function getUint32ArrayMemory0() {
    if (cachedUint32ArrayMemory0 === null || cachedUint32ArrayMemory0.byteLength === 0 || cachedUint32ArrayMemory0.buffer.detached === true || (cachedUint32ArrayMemory0.buffer.detached === undefined && cachedUint32ArrayMemory0.buffer !== wasm.memory.buffer)) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('stegabyte_stego_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
